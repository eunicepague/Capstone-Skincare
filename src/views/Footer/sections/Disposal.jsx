            ...
            <section>
              <Row className="mb-5">
                ...
                <Col>
                  ...
                  <p>
                    ...
                    dropper, pump, and other components and rinse the bottle/jar
                    with water.
                  </p>
                </Col>
              </Row>
              ...
              <Row className="mb-5">
                ...
                <Col>
                  ...
                  <p>Otherwise, dispose via our in-store recycling program.</p>
                </Col>
              </Row>
              ...
              <Row className="mb-5">
                ...
                <Col>
                  ...
                  <p>
                    # 5 PP bottles are usually recyclable through local curbside
                    recycling programs. Please contact your local recycling
              ...
              <Row className="mb-5">
                ...
                <Col>
                  ...
                  <p>
                    Recyclable through the majority of local curbside recycling
                    programs.
                  </p>
                </Col>
              </Row>
              ...
              <Row className="mb-5">
                ...
                <Col>
                  ...
                  <p>
                    ...
                    jurisdictions, we suggest they are disposed via our in-store
                    recycling program.
                  </p>
                </Col>
              </Row>
              ...
              <Row className="mb-5">
                ...
                <Col>
                  ...
                  <p>
                    ...
                    recycling programs. Contact your local recycling facility to
              ...
              <Row className="mb-5">
                ...
                <Col>
                  ...
                  <p>
                    Recyclable through the majority of local curbside recycling
                    programs. It’s best practice to remove the PET liner on the
                    inside prior to recycling.
                  </p>
                  <p>Otherwise, dispose via our in-store recycling program.</p>
                </Col>
              </Row>
